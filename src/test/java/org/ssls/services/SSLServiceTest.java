...
public class SSLServiceTest {
	...
	public void shouldExtractIgnoringCiphers() {
		...
		String content = "2020-07-14 13:00:51,105 INFO  [org.jboss.modules] (main) JBoss Modules version 1.5.3.Final-redhat-1\n"
				...
				+ "2020-07-14 13:25:21,095 INFO  [org.jboss.as.server.deployment] (MSC service thread 1-1) WFLYSRV0208: Stopped subdeployment (runtime-name: PlantOpsStaticContent-JBoss.war) in 213ms\n"
				+ "2020-07-14 13:25:21,100 INFO  [org.jboss.as.server.deployment] (MSC service thread 1-1) WFLYSRV0028: Stopped deployment ProductionCentreWebStart.ear (runtime-name: ProductionCentreWebStart.ear) in 215ms\n"
				+ "2020-07-14 13:25:21,147 INFO  [org.apache.activemq.artemis.core.server] (ServerService Thread Pool -- 84) AMQ221002: Apache ActiveMQ Artemis Message Broker version 1.1.0.SP20-redhat-1 [d92ba89f-5f75-11e9-833c-5beea8ddfa45] stopped\n"
				+ "2020-07-14 13:25:21,147 TRACE [org.jboss.security] (MSC service thread 1-1) PBOX00227: removeAppConfig(other)\n"
				...
				+ "2020-07-14 13:25:21,148 INFO  [org.wildfly.extension.undertow] (MSC service thread 1-1) WFLYUT0007: Undertow HTTP listener default stopped, was bound to 0.0.0.0:8080\n"
				...
				+ "2020-07-14 13:25:21,357 INFO  [org.jboss.as.server.deployment] (MSC service thread 1-8) WFLYSRV0028: Stopped deployment FTPCApps.war (runtime-name: FTPCApps.war) in 474ms\n"
				+ "2020-07-14 13:25:31,452 INFO  [org.jboss.as.server.deployment] (MSC service thread 1-4) WFLYSRV0208: Stopped subdeployment (runtime-name: PharmaSuite-Help.war) in 10568ms\n"
				+ "2020-07-14 13:25:31,464 INFO  [org.jboss.as.server.deployment] (MSC service thread 1-4) WFLYSRV0028: Stopped deployment PharmaSuite-Help.ear (runtime-name: PharmaSuite-Help.ear) in 10582ms\n"
		...
		List<String> ignoringUnavailableCiphers = sslService.extractIgnoringUnavailableCiphers(content);
