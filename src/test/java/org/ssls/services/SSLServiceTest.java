...
public class SSLServiceTest {
	...
	/*
	 * @Inject SSLService sslService;
	 * 
	 * @ConfigProperty(name = "regex.ignoring.unavailable.cipher") String
	 * ignoringUnavaiableCipherRegex;
	 * 
	 * @ConfigProperty(name = "regex.ignoring.unsuported.cipher") String
	 * ignoringUnsuportedCipherRegex;
	 * 
	 * @ConfigProperty(name = "regex.ignoring.disabled.cipher") String
	 * ignoringDisabledCipherRegex;
	 * 
	 * @Test public void shouldExtractIgnoringCiphers() {
	 * 
	 * String content =
	 * "2020-07-14 13:00:51,105 INFO  [org.jboss.modules] (main) JBoss Modules version 1.5.3.Final-redhat-1\n"
	 * +
	 ...
	 * ;
	 * 
	 * Set<String> ignoringUnavailableCiphers =
	 * RegexUtils.extractListByRegexAndGroup(content, ignoringUnavaiableCipherRegex,
	 * 2); assertEquals(6, ignoringUnavailableCiphers.size());
	 * assertTrue(ignoringUnavailableCiphers.stream().anyMatch(cipher ->
	 * "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384".equals(cipher)));
	 * 
	 * }
	 * 
	 * @Test public void shouldExtractTrustStoreInfo() {
	 * 
	 * String content =
	 * "2020-07-14 13:01:50,244 INFO  [stdout] (default task-1) Ignoring unavailable cipher suite: TLS_DHE_RSA_WITH_AES_256_CBC_SHA\n"
	 * +
	 ...
	 * 
	 * assertEquals("D:\\FOO\\Java\\jre\\lib\\security\\cacerts",
	 * trustStoreInfo.path); assertEquals("jks", trustStoreInfo.type);
	 * assertEquals("", trustStoreInfo.provider);
	 * assertTrue(trustStoreInfo.lastTimemodified.equals("")); }
	 * 
	 * @Test public void shouldExtractTrustedCertificatesWithOneCert() throws
	 * IOException {
	 * 
	 * String content =
	 * "2020-07-14 13:25:21,357 INFO  [org.jboss.as.server.deployment] (MSC service thread 1-8) adding as trusted cert:\n"
	 * +
	 ...
	 * sslService.extractTrustedCertificates(content);
	 * 
	 * assertEquals(1, trustedCertificates.size());
	 * assertEquals("C=AA, O=BBB, OU=CCC, CN=DDD Root",
	 * trustedCertificates.get(0).subject);
	 * assertEquals("C=AA, O=BBB, OU=CCC, CN=DDD Root",
	 * trustedCertificates.get(0).issuer);
	 * assertEquals("Fri Apr 18 12:24:22 EDT 2008",
	 * trustedCertificates.get(0).validFrom);
	 * assertEquals("Thu Apr 13 12:24:22 EDT 2028",
	 * trustedCertificates.get(0).validEnd); }
	 * 
	 * @Test public void shouldExtractKeyStoreInfo() {
	 * 
	 * String content =
	 * "2020-07-14 13:01:50,244 INFO  [stdout] (default task-1) Ignoring unavailable cipher suite: TLS_DHE_RSA_WITH_AES_256_CBC_SHA\n"
	 * +
	 ...
	 * 
	 * assertEquals("", trustStoreInfo.path); assertEquals("jks",
	 * trustStoreInfo.type); assertEquals("", trustStoreInfo.provider);
	 * 
	 * }
	 * 
	 * @Test public void shouldExtractUnsupportedCiphers() {
	 * 
	 * String content =
	 * "2020-07-14 13:00:51,105 INFO  [org.jboss.modules] (main) JBoss Modules version 1.5.3.Final-redhat-1\n"
	 * +
	 ...
	 * ;
	 * 
	 * Set<String> ignoringUnsupportedCiphers =
	 * RegexUtils.extractListByRegexAndGroup(content, ignoringUnsuportedCipherRegex,
	 * 2); assertEquals(4, ignoringUnsupportedCiphers.size());
	 * assertTrue(ignoringUnsupportedCiphers.stream().anyMatch(cipher ->
	 * "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256 for TLSv1".equals(cipher)));
	 * 
	 * }
	 * 
	 * @Test public void shouldExtractClientHelloInfo() {
	 * 
	 * }
	 * 
	 * @Test public void shouldExtractServerHelloInfo() throws IOException {
	 * 
	 * }
	 */
